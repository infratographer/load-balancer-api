...
func TestGetLoadBalancer(t *testing.T) {
	...
	"data": {
		...
		require.Len(t, lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges, 1)
		assert.Equal(t, "loadpol-pooly", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.ID)
		assert.Equal(t, "pooly", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Name)
		assert.Equal(t, "tcp", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Protocol)

		require.Len(t, lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Origins.Edges, 1)
		assert.Equal(t, "loadori-origin", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Origins.Edges[0].Node.ID)
		assert.Equal(t, "origin", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Origins.Edges[0].Node.Name)
		assert.Equal(t, "1.2.3.4", lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Origins.Edges[0].Node.Target)
		assert.Equal(t, int64(80), lb.LoadBalancer.Ports.Edges[0].Node.Pools.Edges[0].Node.Origins.Edges[0].Node.PortNumber)

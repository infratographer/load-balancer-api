...
var AssignmentTableColumns = struct {
	...
	LoadBalancerID: "assignments.load_balancer_id",
...
func (r *assignmentR) GetLoadBalancer() *LoadBalancer {
	if r == nil {
		return nil
	}
...
func (o *Assignment) LoadBalancer(mods ...qm.QueryMod) loadBalancerQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (assignmentL) LoadLoadBalancer(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAssignment interface{}, mods queries.Applicator) error {
	var slice []*Assignment
	var object *Assignment
...
// SetLoadBalancer of the assignment to the related item.
// Sets o.R.LoadBalancer to related.
// Adds o to related.R.Assignments.
func (o *Assignment) SetLoadBalancer(ctx context.Context, exec boil.ContextExecutor, insert bool, related *LoadBalancer) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	values := []interface{}{related.LoadBalancerID, o.AssignmentID}

...
type Entity0 struct {
	FindLoadBalancerByID           LoadBalancer           `json:"findLoadBalancerByID"`
	FindLoadBalancerAnnotationByID LoadBalancerAnnotation `json:"findLoadBalancerAnnotationByID"`
	FindLoadBalancerOriginByID     LoadBalancerOrigin     `json:"findLoadBalancerOriginByID"`
	FindLoadBalancerPoolByID       LoadBalancerPool       `json:"findLoadBalancerPoolByID"`
	FindLoadBalancerPortByID       LoadBalancerPort       `json:"findLoadBalancerPortByID"`
	FindLoadBalancerProviderByID   LoadBalancerProvider   `json:"findLoadBalancerProviderByID"`
	FindLoadBalancerStatusByID     LoadBalancerStatus     `json:"findLoadBalancerStatusByID"`
	FindLocationByID               Location               `json:"findLocationByID"`
...
// The id of the object.
func (this LoadBalancerAnnotation) GetID() gidx.PrefixedID { return this.ID }
...
// The id of the object.
func (this LoadBalancerStatus) GetID() gidx.PrefixedID { return this.ID }
...
const (
	LoadBalancerAnnotationOrderFieldNamespace LoadBalancerAnnotationOrderField = "NAMESPACE"
...
var AllLoadBalancerAnnotationOrderField = []LoadBalancerAnnotationOrderField{
	LoadBalancerAnnotationOrderFieldNamespace,
	LoadBalancerAnnotationOrderFieldCreatedAt,
	LoadBalancerAnnotationOrderFieldUpdatedAt,
}

func (e LoadBalancerAnnotationOrderField) IsValid() bool {
	switch e {
	case LoadBalancerAnnotationOrderFieldNamespace, LoadBalancerAnnotationOrderFieldCreatedAt, LoadBalancerAnnotationOrderFieldUpdatedAt:
		return true
	}
	return false
}
...
func (e *LoadBalancerAnnotationOrderField) UnmarshalGQL(v interface{}) error {
	...
	*e = LoadBalancerAnnotationOrderField(str)
	if !e.IsValid() {
...
func (e LoadBalancerOriginOrderField) IsValid() bool {
	switch e {
	case LoadBalancerOriginOrderFieldCreatedAt, LoadBalancerOriginOrderFieldUpdatedAt, LoadBalancerOriginOrderFieldName, LoadBalancerOriginOrderFieldTarget, LoadBalancerOriginOrderFieldNumber, LoadBalancerOriginOrderFieldActive:
		return true
	}
	return false
}
...
const (
	LoadBalancerStatusOrderFieldNamespace LoadBalancerStatusOrderField = "NAMESPACE"
...
var AllLoadBalancerStatusOrderField = []LoadBalancerStatusOrderField{
	LoadBalancerStatusOrderFieldNamespace,
	LoadBalancerStatusOrderFieldCreatedAt,
	LoadBalancerStatusOrderFieldUpdatedAt,
}

func (e LoadBalancerStatusOrderField) IsValid() bool {
	switch e {
	case LoadBalancerStatusOrderFieldNamespace, LoadBalancerStatusOrderFieldCreatedAt, LoadBalancerStatusOrderFieldUpdatedAt:
		return true
	}
	return false
}
...
func (e *LoadBalancerStatusOrderField) UnmarshalGQL(v interface{}) error {
	...
	*e = LoadBalancerStatusOrderField(str)
	if !e.IsValid() {

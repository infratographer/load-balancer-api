...
import (
	...
	"go.infratographer.com/load-balancer-api/internal/ent/schema/schematype"
...
func init() {
	loadbalancerMixin := schematype.LoadBalancer{}.Mixin()
	loadbalancerHooks := schematype.LoadBalancer{}.Hooks()
	loadbalancer.Hooks[0] = loadbalancerHooks[0]
	loadbalancerMixinFields0 := loadbalancerMixin[0].Fields()
	_ = loadbalancerMixinFields0
	loadbalancerFields := schematype.LoadBalancer{}.Fields()
	...
	loadbalancerannotationMixin := schematype.LoadBalancerAnnotation{}.Mixin()
	...
	loadbalancerannotationFields := schematype.LoadBalancerAnnotation{}.Fields()
	...
	loadbalancerstatusMixin := schematype.LoadBalancerStatus{}.Mixin()
	...
	loadbalancerstatusFields := schematype.LoadBalancerStatus{}.Fields()
	...
	originMixin := schematype.Origin{}.Mixin()
	originMixinFields0 := originMixin[0].Fields()
	_ = originMixinFields0
	originFields := schematype.Origin{}.Fields()
	_ = originFields
	...
	poolMixin := schematype.Pool{}.Mixin()
	poolMixinFields0 := poolMixin[0].Fields()
	_ = poolMixinFields0
	poolFields := schematype.Pool{}.Fields()
	_ = poolFields
	...
	portMixin := schematype.Port{}.Mixin()
	portHooks := schematype.Port{}.Hooks()
	port.Hooks[0] = portHooks[0]
	portMixinFields0 := portMixin[0].Fields()
	_ = portMixinFields0
	portFields := schematype.Port{}.Fields()
	_ = portFields
	...
	providerMixin := schematype.Provider{}.Mixin()
	providerMixinFields0 := providerMixin[0].Fields()
	_ = providerMixinFields0
	providerFields := schematype.Provider{}.Fields()
	_ = providerFields

...
type Client struct {
	...
	// LoadBalancerAnnotation is the client for interacting with the LoadBalancerAnnotation builders.
	LoadBalancerAnnotation *LoadBalancerAnnotationClient
	// LoadBalancerStatus is the client for interacting with the LoadBalancerStatus builders.
	LoadBalancerStatus *LoadBalancerStatusClient
...
func (c *Client) init() {
	...
	c.LoadBalancerAnnotation = NewLoadBalancerAnnotationClient(c.config)
	c.LoadBalancerStatus = NewLoadBalancerStatusClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		...
		LoadBalancerAnnotation: NewLoadBalancerAnnotationClient(cfg),
		LoadBalancerStatus:     NewLoadBalancerStatusClient(cfg),
...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.LoadBalancer, c.LoadBalancerAnnotation, c.LoadBalancerStatus, c.Origin,
		c.Pool, c.Port, c.Provider,
	} {
		n.Use(hooks...)
	}
}
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	case *LoadBalancerAnnotationMutation:
		return c.LoadBalancerAnnotation.mutate(ctx, m)
	case *LoadBalancerStatusMutation:
		return c.LoadBalancerStatus.mutate(ctx, m)
	case *OriginMutation:
...
// QueryAnnotations queries the annotations edge of a LoadBalancer.
func (c *LoadBalancerClient) QueryAnnotations(lb *LoadBalancer) *LoadBalancerAnnotationQuery {
	query := (&LoadBalancerAnnotationClient{config: c.config}).Query()
...
// QueryStatuses queries the statuses edge of a LoadBalancer.
func (c *LoadBalancerClient) QueryStatuses(lb *LoadBalancer) *LoadBalancerStatusQuery {
	query := (&LoadBalancerStatusClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := lb.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(loadbalancer.Table, loadbalancer.FieldID, id),
...
// LoadBalancerAnnotationClient is a client for the LoadBalancerAnnotation schema.
type LoadBalancerAnnotationClient struct {
	config
}

// NewLoadBalancerAnnotationClient returns a client for the LoadBalancerAnnotation from the given config.
func NewLoadBalancerAnnotationClient(c config) *LoadBalancerAnnotationClient {
	return &LoadBalancerAnnotationClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `loadbalancerannotation.Hooks(f(g(h())))`.
func (c *LoadBalancerAnnotationClient) Use(hooks ...Hook) {
	c.hooks.LoadBalancerAnnotation = append(c.hooks.LoadBalancerAnnotation, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `loadbalancerannotation.Intercept(f(g(h())))`.
func (c *LoadBalancerAnnotationClient) Intercept(interceptors ...Interceptor) {
	c.inters.LoadBalancerAnnotation = append(c.inters.LoadBalancerAnnotation, interceptors...)
}

// Create returns a builder for creating a LoadBalancerAnnotation entity.
func (c *LoadBalancerAnnotationClient) Create() *LoadBalancerAnnotationCreate {
	mutation := newLoadBalancerAnnotationMutation(c.config, OpCreate)
	return &LoadBalancerAnnotationCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LoadBalancerAnnotation entities.
func (c *LoadBalancerAnnotationClient) CreateBulk(builders ...*LoadBalancerAnnotationCreate) *LoadBalancerAnnotationCreateBulk {
	return &LoadBalancerAnnotationCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for LoadBalancerAnnotation.
func (c *LoadBalancerAnnotationClient) Update() *LoadBalancerAnnotationUpdate {
	mutation := newLoadBalancerAnnotationMutation(c.config, OpUpdate)
	return &LoadBalancerAnnotationUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LoadBalancerAnnotationClient) UpdateOne(lba *LoadBalancerAnnotation) *LoadBalancerAnnotationUpdateOne {
	mutation := newLoadBalancerAnnotationMutation(c.config, OpUpdateOne, withLoadBalancerAnnotation(lba))
	return &LoadBalancerAnnotationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LoadBalancerAnnotationClient) UpdateOneID(id gidx.PrefixedID) *LoadBalancerAnnotationUpdateOne {
	mutation := newLoadBalancerAnnotationMutation(c.config, OpUpdateOne, withLoadBalancerAnnotationID(id))
	return &LoadBalancerAnnotationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LoadBalancerAnnotation.
func (c *LoadBalancerAnnotationClient) Delete() *LoadBalancerAnnotationDelete {
	mutation := newLoadBalancerAnnotationMutation(c.config, OpDelete)
	return &LoadBalancerAnnotationDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LoadBalancerAnnotationClient) DeleteOne(lba *LoadBalancerAnnotation) *LoadBalancerAnnotationDeleteOne {
	return c.DeleteOneID(lba.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LoadBalancerAnnotationClient) DeleteOneID(id gidx.PrefixedID) *LoadBalancerAnnotationDeleteOne {
	builder := c.Delete().Where(loadbalancerannotation.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LoadBalancerAnnotationDeleteOne{builder}
}

// Query returns a query builder for LoadBalancerAnnotation.
func (c *LoadBalancerAnnotationClient) Query() *LoadBalancerAnnotationQuery {
	return &LoadBalancerAnnotationQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLoadBalancerAnnotation},
		inters: c.Interceptors(),
	}
}

// Get returns a LoadBalancerAnnotation entity by its id.
func (c *LoadBalancerAnnotationClient) Get(ctx context.Context, id gidx.PrefixedID) (*LoadBalancerAnnotation, error) {
	return c.Query().Where(loadbalancerannotation.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LoadBalancerAnnotationClient) GetX(ctx context.Context, id gidx.PrefixedID) *LoadBalancerAnnotation {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryLoadBalancer queries the load_balancer edge of a LoadBalancerAnnotation.
func (c *LoadBalancerAnnotationClient) QueryLoadBalancer(lba *LoadBalancerAnnotation) *LoadBalancerQuery {
	query := (&LoadBalancerClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := lba.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(loadbalancerannotation.Table, loadbalancerannotation.FieldID, id),
		...
		fromV = sqlgraph.Neighbors(lba.driver.Dialect(), step)
		return fromV, nil
	}
	return query
}
...
// Hooks returns the client hooks.
func (c *LoadBalancerAnnotationClient) Hooks() []Hook {
	return c.hooks.LoadBalancerAnnotation
}

// Interceptors returns the client interceptors.
func (c *LoadBalancerAnnotationClient) Interceptors() []Interceptor {
	return c.inters.LoadBalancerAnnotation
}

func (c *LoadBalancerAnnotationClient) mutate(ctx context.Context, m *LoadBalancerAnnotationMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LoadBalancerAnnotationCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LoadBalancerAnnotationUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LoadBalancerAnnotationUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LoadBalancerAnnotationDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("generated: unknown LoadBalancerAnnotation mutation op: %q", m.Op())
	}
}

// LoadBalancerStatusClient is a client for the LoadBalancerStatus schema.
type LoadBalancerStatusClient struct {
	config
}

// NewLoadBalancerStatusClient returns a client for the LoadBalancerStatus from the given config.
func NewLoadBalancerStatusClient(c config) *LoadBalancerStatusClient {
	return &LoadBalancerStatusClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `loadbalancerstatus.Hooks(f(g(h())))`.
func (c *LoadBalancerStatusClient) Use(hooks ...Hook) {
	c.hooks.LoadBalancerStatus = append(c.hooks.LoadBalancerStatus, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `loadbalancerstatus.Intercept(f(g(h())))`.
func (c *LoadBalancerStatusClient) Intercept(interceptors ...Interceptor) {
	c.inters.LoadBalancerStatus = append(c.inters.LoadBalancerStatus, interceptors...)
}

// Create returns a builder for creating a LoadBalancerStatus entity.
func (c *LoadBalancerStatusClient) Create() *LoadBalancerStatusCreate {
	mutation := newLoadBalancerStatusMutation(c.config, OpCreate)
	return &LoadBalancerStatusCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of LoadBalancerStatus entities.
func (c *LoadBalancerStatusClient) CreateBulk(builders ...*LoadBalancerStatusCreate) *LoadBalancerStatusCreateBulk {
	return &LoadBalancerStatusCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for LoadBalancerStatus.
func (c *LoadBalancerStatusClient) Update() *LoadBalancerStatusUpdate {
	mutation := newLoadBalancerStatusMutation(c.config, OpUpdate)
	return &LoadBalancerStatusUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *LoadBalancerStatusClient) UpdateOne(lbs *LoadBalancerStatus) *LoadBalancerStatusUpdateOne {
	mutation := newLoadBalancerStatusMutation(c.config, OpUpdateOne, withLoadBalancerStatus(lbs))
	return &LoadBalancerStatusUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *LoadBalancerStatusClient) UpdateOneID(id gidx.PrefixedID) *LoadBalancerStatusUpdateOne {
	mutation := newLoadBalancerStatusMutation(c.config, OpUpdateOne, withLoadBalancerStatusID(id))
	return &LoadBalancerStatusUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for LoadBalancerStatus.
func (c *LoadBalancerStatusClient) Delete() *LoadBalancerStatusDelete {
	mutation := newLoadBalancerStatusMutation(c.config, OpDelete)
	return &LoadBalancerStatusDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *LoadBalancerStatusClient) DeleteOne(lbs *LoadBalancerStatus) *LoadBalancerStatusDeleteOne {
	return c.DeleteOneID(lbs.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *LoadBalancerStatusClient) DeleteOneID(id gidx.PrefixedID) *LoadBalancerStatusDeleteOne {
	builder := c.Delete().Where(loadbalancerstatus.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &LoadBalancerStatusDeleteOne{builder}
}

// Query returns a query builder for LoadBalancerStatus.
func (c *LoadBalancerStatusClient) Query() *LoadBalancerStatusQuery {
	return &LoadBalancerStatusQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeLoadBalancerStatus},
		inters: c.Interceptors(),
	}
}

// Get returns a LoadBalancerStatus entity by its id.
func (c *LoadBalancerStatusClient) Get(ctx context.Context, id gidx.PrefixedID) (*LoadBalancerStatus, error) {
	return c.Query().Where(loadbalancerstatus.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *LoadBalancerStatusClient) GetX(ctx context.Context, id gidx.PrefixedID) *LoadBalancerStatus {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// Hooks returns the client hooks.
func (c *LoadBalancerStatusClient) Hooks() []Hook {
	return c.hooks.LoadBalancerStatus
}

// Interceptors returns the client interceptors.
func (c *LoadBalancerStatusClient) Interceptors() []Interceptor {
	return c.inters.LoadBalancerStatus
}

func (c *LoadBalancerStatusClient) mutate(ctx context.Context, m *LoadBalancerStatusMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&LoadBalancerStatusCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&LoadBalancerStatusUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&LoadBalancerStatusUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&LoadBalancerStatusDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("generated: unknown LoadBalancerStatus mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		LoadBalancer, LoadBalancerAnnotation, LoadBalancerStatus, Origin, Pool, Port,
		Provider []ent.Hook
	}
	inters struct {
		LoadBalancer, LoadBalancerAnnotation, LoadBalancerStatus, Origin, Pool, Port,
